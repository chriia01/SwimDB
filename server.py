...
if session.query(race.id).filter_by(id=1).count() == 0:
    ...
    session.add(swimmer(name="Ian Christopherson", gender="M", team="Luther", birthdate=date(1996,1,3)))
    session.add(swimmer(name="Gunnar Swanson", gender="M", team="Luther", birthdate=date(1995,2,26)))
    session.add(swimmer(name="Martha Stelter", gender="F", team="Luther", birthdate=date(1997,4,13)))

    session.add(swimmer(name="Corbin Faidley", gender="M", team="Coe", birthdate=date(1997,4,13)))
    session.add(swimmer(name="Quincy Markham", gender="M", team="Coe", birthdate=date(1998,6,12)))

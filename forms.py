...
class TimeForm(Form):
    ...
    minutes = IntegerField("Time (min,sec,ms)", [validators.Required("Please enter minutes"),validators.NumberRange(min=0,max=59, message="Please enter a number between 0 and 59")], default=0)
